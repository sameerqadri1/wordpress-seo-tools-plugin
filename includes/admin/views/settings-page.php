                    ...
                    <tr>
                        ...
                        <td>
                            <select id="seo_tools_gemini_model" name="seo_tools_gemini_model">
                                <option value="gemini-2.0-flash-lite" <?php selected(get_option('seo_tools_gemini_model', 'gemini-2.0-flash-lite'), 'gemini-2.0-flash-lite'); ?>>
                                    Gemini 2.0 Flash-Lite (Recommended - Free Tier)
                                </option>
                            ...
                            <p class="description">Select the Gemini model to use. Flash-Lite is best for free tier.</p>
                        </td>
                    </tr>
                </table>
            </div>
